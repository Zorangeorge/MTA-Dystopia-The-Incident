...
addEventHandler( "onResourceStart", resourceRoot,
    function()
        ...
        -- Create the objects
        mainObject = getElementByID("warrig1vehicle")
		...
		setVehicleRespawnPosition(mainObject,346.646484375, 864.0234375, 21.40625)
		respawnVehicle(mainObject,346.646484375, 864.0234375, 21.40625)

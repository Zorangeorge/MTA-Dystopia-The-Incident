...
addEventHandler( "onResourceStart", resourceRoot,
    function()
        ...
        -- Create the objects
        mainObject = getElementByID("tradertruck1vehicle")
		...
		setVehicleRespawnPosition(mainObject,-2465.88671875, 740.9375, 35.452056884766)
		respawnVehicle(mainObject,-2465.88671875, 740.9375, 35.452056884766)
		--setTimer(function()  respawnVehicle(mainObject) setVehicleLocked ( mainObject, false )end,5000,1)
		--setVehicleVariant(0,1)

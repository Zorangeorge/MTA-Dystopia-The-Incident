...
addEventHandler( "onResourceStart", resourceRoot,
    function()
        ...
        -- Create the objects
        mainObject = getElementByID("tradeboat1vehicle")
		...
		setVehicleRespawnPosition(mainObject,2107.2099609375, -107.7802734375, -0.55000001192093)
		setVehicleRespawnRotation(mainObject,0, 0, 131.23645019531)
		respawnVehicle(mainObject,2107.2099609375, -107.7802734375, -0.55000001192093)

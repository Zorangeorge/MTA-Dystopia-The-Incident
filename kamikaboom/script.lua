...
addEventHandler( "onResourceStart", resourceRoot,
    function()
        ...
        -- Create the objects
        mainObject = getElementByID("kamikaboom1vehicle")
		...
		setVehicleRespawnPosition(mainObject,2593,2276,12)
		respawnVehicle(mainObject,2593,2276,12)
		...
		setTimer(function()setElementData(mainObject,"setup","Kamikaboom")end,10000,1)
    end
)
...
addCommandHandler("kamikaboom", spawnCruiserToPlayer)
...
addEventHandler( "onResourceStart", resourceRoot,
    function()
        ...
        -- Create the objects
        mainObject = getElementByID("raiderDozer1vehicle")
		...
		setVehicleRespawnPosition(mainObject,2743,921,11)
		respawnVehicle(mainObject,2743,921,11)
...
function spawnDozerToPlayer(p, c)
...
addCommandHandler("getdozer", spawnDozerToPlayer)
...
addEventHandler( "onResourceStart", resourceRoot,
    function()
        ...
        -- Create the objects
        mainObject = getElementByID("missileboat1vehicle")
		...
		setVehicleRespawnPosition(mainObject,-2216.6611328125, 2416.6474609375, 0.82615889310837)
		setVehicleRespawnRotation(mainObject,0, 0, 44.849609375)
		respawnVehicle(mainObject,-2216.6611328125, 2416.6474609375, 0.82615889310837)

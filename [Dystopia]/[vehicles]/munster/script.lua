...
addEventHandler( "onResourceStart", resourceRoot,
    function()
        ...
        -- Create the objects
        mainObject = getElementByID("raidermunster1vehicle")
		...
		setVehicleRespawnPosition(mainObject,210.51953125, 1450.560546875, 10.5859375)
		respawnVehicle(mainObject,210.51953125, 1450.560546875, 10.5859375)
...
function bringVehicleToPlayer(p, c)
...
addCommandHandler("getmunster", bringVehicleToPlayer)

function createDrawingWindow()
	...
	draw_window = guiCreateWindow((sw-128)*0.5,(sh-384)*0.5,365,384,"Drawing",false)
	...
	button_clear = guiCreateButton(304,315,64,24,"Clear",false,draw_window)
...
function setDefaultColors()
	local r,g,b = {},{},{}
	colors = {r = r,g = g,b = b}
	r[0x01],g[0x01],b[0x01] = 192, 192, 192 
	r[0x02],g[0x02],b[0x02] = 158, 106, 58
	r[0x03],g[0x03],b[0x03] = 95, 95, 95
	r[0x04],g[0x04],b[0x04] = 72, 108, 176
	r[0x05],g[0x05],b[0x05] = 235, 58, 19 
	r[0x06],g[0x06],b[0x06] = 255, 204, 0 
	r[0x07],g[0x07],b[0x07] = 0, 153, 0
	r[0x08],g[0x08],b[0x08] = 0, 0, 0 
...
function buttonDoneDrawing(button,state) --saves drawing and closes window
	if button ~= "left" or state ~= "up" then return end
	updateTagPNGData()
	showDrawingWindow(false)
end

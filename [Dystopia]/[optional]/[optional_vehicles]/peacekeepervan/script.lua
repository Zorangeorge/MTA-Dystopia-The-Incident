...
addEventHandler( "onResourceStart", resourceRoot,
    function()
        ...
        -- Create the objects
        mainObject = getElementByID("peacekeepervan1vehicle")
		...
		setVehicleRespawnPosition(mainObject,224.2294921875, 2015.232421875, 17.935790634155)
		setVehicleRespawnRotation(mainObject,0, 0, 350.46154785156)
		respawnVehicle(mainObject,224.2294921875, 2015.232421875, 17.935790634155)
...
addCommandHandler("peacekepervan", spawnCruiserToPlayer)
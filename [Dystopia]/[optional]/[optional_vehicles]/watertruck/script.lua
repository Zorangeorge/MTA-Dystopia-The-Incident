...
addEventHandler( "onResourceStart", resourceRoot,
    function()
        ...
        -- Create the objects
        mainObject = getElementByID("watertruck1vehicle")
		...
		setVehicleRespawnPosition(mainObject,196.0849609375, 2015.58984375, 17.340219497681)
		setVehicleRespawnRotation(mainObject,0, 0, 90)
		respawnVehicle(mainObject,196.0849609375, 2015.58984375, 17.340219497681)

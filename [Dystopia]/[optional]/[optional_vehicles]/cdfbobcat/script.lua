...
addEventHandler( "onResourceStart", resourceRoot,
    function()
        ...
        -- Create the objects
        mainObject = getElementByID("cdfbobcat1vehicle")
		...
		setVehicleRespawnPosition(mainObject,637,-592,17)
		respawnVehicle(mainObject,637.-592,17)
...
function spawnBobcatToPlayer(p, c)
...
addCommandHandler("spawncdfbobcat", spawnBobcatToPlayer)
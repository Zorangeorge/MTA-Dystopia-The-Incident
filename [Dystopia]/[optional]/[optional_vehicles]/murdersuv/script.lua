...
addEventHandler( "onResourceStart", resourceRoot,
    function()
        ...
        -- Create the objects
        mainObject = getElementByID("raiderhuntley1vehicle")
		...
		setVehicleRespawnPosition(mainObject,932.8369140625,2066.210937,10.8203125)
		respawnVehicle(mainObject,932.8369140625,2066.210937,10.8203125)
...
function spawnHuntleyToPlayer(p, c)
...
addCommandHandler("getmurdersuv", spawnHuntleyToPlayer)

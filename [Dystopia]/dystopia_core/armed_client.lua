...
addEventHandler("onClientPreRender",root,function()
	for k,v in pairs(players) do
		...
		local object_armor = createObject(373,x,y,z)
		...
		exports.bone_attach:attachElementToBone(object_armor,k,3,0,0,0,   -45, 135, 45  )
		setElementCollisionsEnabled(object_armor,false)
		--setObjectScale(object_armor,1.9)
		setElementData(k,"armor_obj",object_armor)
		elseif getPedArmor(k) == 0 and getElementData(k,"armor_obj") then

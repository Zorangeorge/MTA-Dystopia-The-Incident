...
function startclimb(x, y, z, wallangle)
	...
	local ped = source
	setTimer(function() setPedAnimation( ped, "bmx", "BMX_pedal", -1, false, false, false, true,200) end, 200,1)
...
function roofclimb()
	local climbobject = getElementData( source, "climb_object" )
	if isElement(climbobject) then
		setPedAnimation( source, "ped", "CLIMB_Stand", -1, false, true, false, true)

--[[function assembleTruck ()

truck = getElementByID("siegeTruck1")
partsTable = getElementsByType("object")
...
addEventHandler("OnResourceStart",getThisResource(),assembleTruck)]]
...
addEventHandler( "onResourceStart", resourceRoot,
    function()
        ...
        -- Create the objects
        mainObject = getElementByID("siegeTruck1")
        subObjects = getElementsByType("object")

...
addEventHandler( "onResourceStart", resourceRoot,
    function()
        ...
        -- Create the objects
        mainObject = getElementByID("siegeTruck1vehicle")
		...
		setVehicleRespawnPosition(mainObject,267.646484375, 1444.15234375, 11.220435142517)
		setVehicleRespawnRotation(mainObject,0, 0, 174.72528076172)
		respawnVehicle(mainObject,267.646484375, 1444.15234375, 11.220435142517)

...
addEventHandler( "onResourceStart", resourceRoot,
    function()
        ...
        -- Create the objects
        mainObject = getElementByID("cdftruck1vehicle")
		...
		setVehicleRespawnPosition(mainObject,644.5361328125, -487.205078125, 16.1875)
		respawnVehicle(mainObject,644.5361328125, -487.205078125, 16.1875)
		setElementRotation(mainObject,0,0,90)
...
addCommandHandler("cdftruck", spawnCruiserToPlayer)
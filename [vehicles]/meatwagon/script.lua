...
addEventHandler( "onResourceStart", resourceRoot,
    function()
        ...
        -- Create the objects
        mainObject = getElementByID("meatwagon1vehicle")
		...
		setVehicleRespawnPosition(mainObject,356.4501953125, 857.65625, 20.3811378479)
		respawnVehicle(mainObject,356.4501953125, 857.65625, 20.3811378479)
